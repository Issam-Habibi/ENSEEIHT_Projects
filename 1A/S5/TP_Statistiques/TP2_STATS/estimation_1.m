...
x_1 = x_donnees_bruitees - mean(x_donnees_bruitees); %prise en compte du centre de gravité.
y_1 = y_donnees_bruitees - mean(y_donnees_bruitees); %prise en compte du centre de gravité.
