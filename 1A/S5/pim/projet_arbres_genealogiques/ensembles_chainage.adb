...
package body Ensembles_Chainage is
    ...
    procedure Remplacer_Ensemble(E1 : IN OUT T_Ensemble ; E : IN T_Ensemble) is
    begin
	E1 := E;
    end Remplacer_Ensemble;

    function get_Element(Ensemble : IN T_Ensemble) return T_Element is
    begin
	return Ensemble.all.Element;
    end get_Element;

    procedure Copie(Element_1 : IN OUT T_Element ; Element_2 : IN T_Element) is
    begin
	Element_1 := Element_2;
    end Copie;
