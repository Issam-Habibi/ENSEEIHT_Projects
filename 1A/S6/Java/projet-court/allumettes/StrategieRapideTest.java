...
public class StrategieRapideTest {
	...
	@Test public void testerT1() {
		...
		assertEquals("la première prise de la stratégie", 3, strategieRapide.prise(jeu));
		...
		assertEquals("La prise quand le jeu ne contient que 2 allumette", 2, strategieRapide.prise(jeu));
		...
		assertEquals("La prise quand le jeu contient 1 seule allumette", 1, strategieRapide.prise(jeu));
