...
public class StrategieLenteTest {
	...
	@Test public void testerT1() {
		...
		assertEquals("la première prise de la stratégie", 1, strategieLente.prise(jeu));
		...
		assertEquals("La prise quand le jeu ne contient que 2 allumette", 1, strategieLente.prise(jeu));
